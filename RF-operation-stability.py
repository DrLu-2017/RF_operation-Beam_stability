"""
Renamed main Streamlit app that integrates ALBuMS home and the RF System page.

Usage: run this file with Streamlit (it replaces the previous `streamlit_app.py`).
"""
...
# Page configuration (single call here)
st.set_page_config(
...
# Simple page selector to integrate the RF system page from cavity_operation.rf_system_pro
page = st.sidebar.selectbox("Select Page", ["ALBuMS Home", "Double RF System Stability"], key="page_selector")

if page == "Double RF System Stability":
    # Import RF page and render it. The rf module exposes build_rf_system_page().
    from cavity_operation import rf_system_pro

    rf_system_pro.build_rf_system_page()
    st.stop()

# -------------------------
# ALBuMS Home content (original `streamlit_app.py`) below
# -------------------------
...
st.info("""
**New to ALBuMS?** Start with the **Parameter Scans** page and select the "Aladdin (Passive HC)" preset 
